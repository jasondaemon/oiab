...
class Settings:
    ...
    filebrowser_internal_url: str = os.environ.get("FILEBROWSER_INTERNAL_URL", "http://filebrowser:80")
    filebrowser_admin_user: str = os.environ.get("FILEBROWSER_ADMIN_USER", "admin")
    filebrowser_admin_password: str = os.environ.get("FILEBROWSER_ADMIN_PASSWORD", "")
...
DATA_SUBDIRS = [
    ...
    "maps/overlays/padus/source",
    "maps/overlays/padus/geojson",
    "maps/overlays/padus/pmtiles",
    "maps/overlays/water/source",
    "maps/overlays/water/geojson",
    "maps/overlays/water/pmtiles",
    "maps/overlays/public-lands/source",
    "maps/overlays/ridb",
    "maps/overlays/campflare",
    "maps/overlays/campflare/raw",
    "maps/overlays/campflare/geojson",
    "maps/overlays/campflare/pmtiles",
    "maps/overlays/drought",
    "maps/overlays/darksky/source",
    "maps/overlays/darksky/tiles",
    "maps/overlays/connectivity",
    "maps/overlays/parcels",
    "maps/overlays/wildfire",
    "maps/overlays/weather",
    "maps/overlays/contours",
